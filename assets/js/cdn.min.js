        ...
        I = function () {
          if (!!r.active)
            return (
              ...
              a.addEventListener("mousedown", y, { capture: !0, passive: !1 }),
              a.addEventListener("touchstart", y, { capture: !0, passive: !1 }),
              a.addEventListener("click", x, { capture: !0, passive: !1 }),
              a.addEventListener("keydown", R, { capture: !0, passive: !1 }),
              s
            );
        },
        P = function () {
            ...
            let b = l(u),
              ...
              y = () => {
                p(),
                  ...
                  E(),
                  (E = () => {}),
                  m.deactivate({ returnFocus: !r.includes("noreturn") });
              };
            s(() =>
              b((w) => {
                v !== w &&
